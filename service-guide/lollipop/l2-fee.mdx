...
-   Lollipop continuously monitors the Ethereum base fee fluctuations; whenever there is a substantial change, a new `l1_base_fee` is stored in the L2 `OVM_GasPriceOracle` contract.
